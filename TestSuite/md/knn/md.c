               ...
               int32_t NL[nAtoms*maxNeighbors])
{
    ...
    dmaLoad(&NL[0], 0, nAtoms*maxNeighbors*sizeof(int32_t));
#endif
...
#ifdef DMA_MODE
    dmaStore(&force_x[0], 0, nAtoms * sizeof(TYPE));
    dmaStore(&force_y[0], 0, nAtoms * sizeof(TYPE));
    dmaStore(&force_z[0], 0, nAtoms * sizeof(TYPE));
#endif
}
